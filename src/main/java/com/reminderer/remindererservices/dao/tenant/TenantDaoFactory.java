...
public class TenantDaoFactory {
	...
	public com.reminderer.remindererservices.service.tenant.Tenant toTenant(Tenant tenant) {
	...
	public com.reminderer.remindererservices.service.util.TenantId toTenantId(Long id) {
		return com.reminderer.remindererservices.service.util.TenantId.builder().id(id).build();

	}

	public Tenant toTenantDao(com.reminderer.remindererservices.service.tenant.Tenant tenantBO) {
